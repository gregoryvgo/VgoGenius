...
export default function Testimonials() {
  const data = [
    ...
    {
      name: "Δημήτρης",
      text: "Οι ψηφιακές λύσεις που μου πρότειναν με ικανοποίησαν πλήρως. Είναι κατά τη γνώμη μου η κορυφαία εταιρεία για μικρές επιχειρήσεις που στηρίζουν σε όλα τα βήματα τον πελάτη και παρέχουν άμεση τεχνική υποστήριξη με ειλικρίνεια και συνέπεια.",
      img: "/images/user2.jpg",
    },
    {
      name: "Μαρία",
      text: "Είμαι πολύ εντυπωσιασμένη με τις επαγγελματικές υπηρεσίες. Η συνεργασία ήταν εξαιρετική και ο Γρηγόρης μας καθοδήγησε με συνέπεια σε οτιδήποτε δεν γνωρίζαμε ή δεν μπορούσαμε να αποφασίσουμε. Οι λύσεις που προτάθηκαν ανταποκρίθηκαν πλήρως στις ανάγκες μας και νιώθουμε σιγουριά για τα επόμενα βήματα ανάπτυξης.",
