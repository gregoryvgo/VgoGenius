  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* First row: OnePager, Βασικό, Επαγγελματικό */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 text-center">
          {/* ⭐ OnePager */}
          <div className="flex flex-col justify-between bg-black border border-[#2d2d2d] rounded-2xl p-6 md:p-8 shadow-[0_0_30px_rgba(226,132,26,0.3)] hover:shadow-[0_0_50px_rgba(226,132,26,0.6)] transition-transform hover:scale-105">
            <div>
            ...
            <Link
              href="/epikoinonia?package=OnePager"
              className="w-full block py-3 bg-[#e2841a] text-black font-semibold rounded-full hover:bg-white hover:text-black transition text-center"
            >
              Επιλογή Πακέτου
            </Link>
          </div>
          ...
          {/* 🔥 Βασικό - HOT SALE */}
          <div className="relative flex flex-col justify-between bg-black border border-[#ff9d00] rounded-2xl p-6 md:p-8 shadow-[0_0_40px_rgba(255,120,0,0.6)] hover:shadow-[0_0_60px_rgba(255,150,0,0.9)] transition-transform hover:scale-105">
            <span className="absolute top-3 left-4 text-[12px] text-[#ffb347] italic tracking-wide">
              hot sale 🔥
            </span>

            <div>
              <h3 className="text-xl md:text-2xl font-semibold text-[#e2841a] mb-4 mt-2">
                Βασικό
              </h3>
            ...
            <Link
              href="/epikoinonia?package=Βασικό"
              className="w-full block py-3 bg-[#e2841a] text-black font-semibold rounded-full hover:bg-white hover:text-black transition text-center"
            >
              Επιλογή Πακέτου
            </Link>
          ...
          {/* Επαγγελματικό */}
          <div className="flex flex-col justify-between bg-black border border-[#2d2d2d] rounded-2xl p-6 md:p-8 shadow-[0_0_40px_rgba(226,132,26,0.4)] hover:shadow-[0_0_60px_rgba(226,132,26,0.7)] transition-transform hover:scale-105">
            <div>
              <h3 className="text-xl md:text-2xl font-semibold text-[#e2841a] mb-4">
                Επαγγελματικό
              </h3>
            ...
            <Link
              href="/epikoinonia?package=Επαγγελματικό"
              className="w-full block py-3 bg-[#e2841a] text-black font-semibold rounded-full hover:bg-white hover:text-black transition text-center"
            >
              Επιλογή Πακέτου
            </Link>
        ...
        <div className="w-full mt-10 flex justify-center">
          <div className="w-full max-w-lg flex flex-col justify-between bg-black border border-[#2d2d2d] rounded-2xl p-6 md:p-8 shadow-[0_0_50px_rgba(226,132,26,0.5)] hover:shadow-[0_0_70px_rgba(226,132,26,0.8)] transition-transform hover:scale-105">
            <div>
            ...
            <Link
              href="/epikoinonia?package=Premium"
              className="w-full block py-3 bg-[#e2841a] text-black font-semibold rounded-full hover:bg-white hover:text-black transition text-center"
            >
              Επιλογή Πακέτου
            </Link>
      ...
      <style jsx global>{`
        ...
        @keyframes fireGlowPulse {
          ...
          100% { shadow: 0 0 25px rgba(226,132,26,0.12); }
        }
